...
local config = {
  ...
  mappings = {
    ...
    n = {
      ...
      ["gt"] = { "<cmd>Telescope lsp_type_definitions theme=dropdown<cr>" },
      ...
      ['<c-e>'] = { '5<c-e>' },
      ['gtj'] = {'<cmd>GoAddTag<cr>', desc='Golang add tag json'}
  ...
  plugins = {
    ...
    },
    {
      ...
      opts = { filesystem = { filtered_items = { hide_gitignored = false, hide_dotfiles = false } } },
    },
    {
      "ray-x/go.nvim",
